...
use gpui::{
    canvas, div, point, prelude::*, px, rgb, size, Bounds, Context, MouseButton, MouseDownEvent,
    MouseUpEvent, SharedString, TouchPhase, Window,
};
                                        ...
                                        TouchPhase::Ended => {
                                                ...
                                                playground.touch_start.take()
                                            {
                                                ...
                                                if elapsed < std::time::Duration::from_millis(200)
                                                    && distance < 20.0
                                                {
                                                    let color_rgb = crate::demos::random_color(
